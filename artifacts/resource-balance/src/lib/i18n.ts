...
const pt = {
  ...
  login: {
    ...
    enter: 'Entrar',
    create: 'Criar conta',
    enterCopy: 'Use o e-mail da sua conta para abrir seus cálculos.',
  ...
  errors: {
    ...
    emailTaken: 'Este e-mail já tem uma conta.',
...
const en: Messages = {
  ...
  login: {
    ...
    enterCopy: 'Use your account email to open your calculations.',
