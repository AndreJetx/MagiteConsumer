...
const pt = {
  ...
  charStats: {
    eyebrow: 'Build do personagem',
    title: 'Status atuais e metas',
    copy: 'Anote o que você tem agora e o alvo que quer alcançar. Números grandes aceitam letras (1.5k, 2m, 1b).',
    hintNumber: 'números · use k m b t',
    hintPercent: 'secundários em % · penetração/aparar/dano fixo em número',
    current: 'Atual',
    goal: 'Meta',
    ofGoal: 'da meta',
    fixed: 'fixo',
    invalidNumber: 'Use número ou sufixo (ex.: 1.5k).',
    groups: {
      final: {
        eyebrow: 'Finais',
        title: 'Atributos finais',
        copy: 'Valores totais do personagem.',
      },
      talent: {
        eyebrow: 'Talento',
        title: 'Talento',
        copy: 'Pontuação de talento.',
      },
      secondary: {
        eyebrow: 'Secundários',
        title: 'Atributos secundários',
        copy: 'Quase todos em %. Penetração, aparar e danos fixos são números (ex.: 1.5k). Vel. de movimento fica fixa em 6.',
      },
      primary: {
        eyebrow: 'Primários',
        title: 'Atributos primários',
        copy: 'Base numérica do personagem.',
      },
    },
    fields: {
      hpFinal: 'PV final',
      atkFinal: 'ATQ final',
      defFinal: 'DEF final',
      manaFinal: 'Mana final',
      guardPoints: 'Pontos de guarda',
      talent: 'Talento',
      moveSpeed: 'Vel. de movimento',
      crit: 'Crítico',
      critRes: 'Res. crítico',
      critDmg: 'Dano crítico',
      critDmgParry: 'Aparo de dano crítico',
      focus: 'Foco',
      focusRes: 'Res. foco',
      focusDmg: 'Dano de foco',
      focusDmgParry: 'Aparo de dano de foco',
      break: 'Quebra',
      breakRes: 'Res. quebra',
      breakDmg: 'Dano de quebra',
      breakDmgParry: 'Aparo de dano de quebra',
      globalDmgBonus: 'Bônus de dano global',
      globalDmgReduction: 'Redução de dano global',
      penetration: 'Penetração',
      parry: 'Aparar',
      dodge: 'Esquiva',
      ignoreDodge: 'Ignorar esquiva',
      block: 'Bloqueio',
      ignoreBlock: 'Ignorar bloqueio',
      cdReduction: 'Redução de CD',
      speed: 'Velocidade',
      regen: 'Regeneração',
      healBonus: 'Bônus de cura',
      monsterDmgBonus: 'Bônus de dano a monstro',
      monsterDmgReduction: 'Redução de dano do monstro',
      spiritDmgBonus: 'Bônus de dano de espírito',
      spiritDmgReduction: 'Redução de dano de espírito',
      basicAtkBonus: 'Bônus de ATQ básico',
      basicAtkReduction: 'Redução de ATQ básico',
      mainSkillBonus: 'Bônus de hab. principal',
      mainSkillReduction: 'Redução de hab. principal',
      activeSkillBonus: 'Bônus de hab. ativa',
      activeSkillReduction: 'Redução de hab. ativa',
      passiveSkillBonus: 'Bônus de hab. passiva',
      passiveSkillReduction: 'Redução de hab. passiva',
      globalSkillBonus: 'Bônus de hab. global',
      globalSkillReduction: 'Redução de hab. global',
      activeSkillFixedDmg: 'Dano fixo de hab. ativa',
      passiveSkillFixedDmg: 'Dano fixo de hab. passiva',
      dmgVsSorcerer: 'Dano contra feiticeiros',
      dmgVsWarrior: 'Dano contra guerreiros',
      dmgVsSwordsman: 'Dano contra espadachins',
      dmgReductionFromSorcerer: 'Redução de dano de feiticeiro',
      dmgReductionFromWarrior: 'Redução de dano de guerreiros',
      dmgReductionFromSwordsman: 'Redução de dano de espadachins',
      manaPercent: '% Mana',
      hpPracticePercent: '% PV prática',
      atkPracticePercent: '% ATQ prática',
      defPracticePercent: '% DEF prática',
      hpGlobalPercent: '% PV global',
      hpSeasonPercent: '% PV temporada',
      atkGlobalPercent: '% ATQ global',
      atkSeasonPercent: '% ATQ temporada',
      defGlobalPercent: '% DEF global',
      defSeasonPercent: '% DEF temporada',
      hpTalentPercent: '% PV talento',
      atkTalentPercent: '% ATQ talento',
      defTalentPercent: '% DEF talento',
      hp: 'PV',
      atk: 'ATQ',
      def: 'DEF',
      mana: 'Mana',
...
const en: Messages = {
  ...
  charStats: {
    ...
    title: 'Current stats and goals',
    copy: 'Track what you have now and the target you want. Large numbers accept letter suffixes (1.5k, 2m, 1b).',
    hintNumber: 'numbers · use k m b t',
    hintPercent: 'secondary in % · penetration/parry/fixed dmg as numbers',
    current: 'Current',
    goal: 'Goal',
    ofGoal: 'of goal',
    fixed: 'fixed',
    invalidNumber: 'Use a number or suffix (e.g. 1.5k).',
    groups: {
      final: {
        eyebrow: 'Final',
        title: 'Final attributes',
        copy: 'Total character values.',
      },
      talent: {
        eyebrow: 'Talent',
        title: 'Talent',
      ...
      secondary: {
        ...
        copy: 'Mostly percentages. Penetration, parry, and fixed damage use numbers (e.g. 1.5k). Move speed is fixed at 6.',
      },
      primary: {
        eyebrow: 'Primary',
        title: 'Primary attributes',
        copy: 'Base numeric attributes.',
      },
    },
    fields: {
      hpFinal: 'Final HP',
      atkFinal: 'Final ATK',
      defFinal: 'Final DEF',
      manaFinal: 'Final Mana',
      guardPoints: 'Guard points',
      talent: 'Talent',
      moveSpeed: 'Move speed',
      crit: 'Crit',
      critRes: 'Crit res.',
      critDmg: 'Crit damage',
      critDmgParry: 'Crit damage parry',
      focus: 'Focus',
      focusRes: 'Focus res.',
      focusDmg: 'Focus damage',
      focusDmgParry: 'Focus damage parry',
      break: 'Break',
      breakRes: 'Break res.',
      breakDmg: 'Break damage',
      breakDmgParry: 'Break damage parry',
      globalDmgBonus: 'Global damage bonus',
      globalDmgReduction: 'Global damage reduction',
      ...
      cdReduction: 'CD reduction',
      speed: 'Speed',
      regen: 'Regen',
      healBonus: 'Heal bonus',
      monsterDmgBonus: 'Monster damage bonus',
      monsterDmgReduction: 'Monster damage reduction',
      spiritDmgBonus: 'Spirit damage bonus',
      spiritDmgReduction: 'Spirit damage reduction',
      basicAtkBonus: 'Basic ATK bonus',
      basicAtkReduction: 'Basic ATK reduction',
      mainSkillBonus: 'Main skill bonus',
      mainSkillReduction: 'Main skill reduction',
      activeSkillBonus: 'Active skill bonus',
      activeSkillReduction: 'Active skill reduction',
      passiveSkillBonus: 'Passive skill bonus',
      passiveSkillReduction: 'Passive skill reduction',
      globalSkillBonus: 'Global skill bonus',
      globalSkillReduction: 'Global skill reduction',
      activeSkillFixedDmg: 'Active skill fixed damage',
      passiveSkillFixedDmg: 'Passive skill fixed damage',
      dmgVsSorcerer: 'Damage vs sorcerers',
      dmgVsWarrior: 'Damage vs warriors',
      dmgVsSwordsman: 'Damage vs swordsmen',
      dmgReductionFromSorcerer: 'Damage reduction from sorcerers',
      dmgReductionFromWarrior: 'Damage reduction from warriors',
      dmgReductionFromSwordsman: 'Damage reduction from swordsmen',
      manaPercent: '% Mana',
      hpPracticePercent: '% Practice HP',
      atkPracticePercent: '% Practice ATK',
      defPracticePercent: '% Practice DEF',
      hpGlobalPercent: '% Global HP',
      hpSeasonPercent: '% Season HP',
      atkGlobalPercent: '% Global ATK',
      atkSeasonPercent: '% Season ATK',
      defGlobalPercent: '% Global DEF',
      defSeasonPercent: '% Season DEF',
      hpTalentPercent: '% Talent HP',
      atkTalentPercent: '% Talent ATK',
      defTalentPercent: '% Talent DEF',
      hp: 'HP',
      atk: 'ATK',
      def: 'DEF',
      mana: 'Mana',
